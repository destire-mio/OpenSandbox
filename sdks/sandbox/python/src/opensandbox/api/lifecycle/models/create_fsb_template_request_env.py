...
T = TypeVar("T", bound="CreateFsbTemplateRequestEnv")


@_attrs_define
class CreateFsbTemplateRequestEnv:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        create_fsb_template_request_env = cls()

        create_fsb_template_request_env.additional_properties = d
        return create_fsb_template_request_env
